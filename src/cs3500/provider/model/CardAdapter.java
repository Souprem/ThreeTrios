...
/**
 * this is an adapter for the providers Card interface. it uses an instance of our own implenentation of card to allow it to work with the rest of our code.
 */
