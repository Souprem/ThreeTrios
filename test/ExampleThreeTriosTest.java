...
public class ExampleThreeTriosTest {
  ...
  public void testEasyGameplayExample() throws IOException {
    ...
    CardConfigReader cardReader = new CardConfigReader("test"
            + File.separator + "configs" + File.separator + "CardConfigSmall");
    BoardConfigReader boardReader = new BoardConfigReader("test"
